...
- 'CodeBook': 
- 'Data' : The final dataset contains the training and test datasets
- 'run_analysis.R' : This script does the following. 
    ...
    STEP 6:From the dataset in step 5, creates a second, independent tidy data set with the average of each variable for each activity and each subject.
